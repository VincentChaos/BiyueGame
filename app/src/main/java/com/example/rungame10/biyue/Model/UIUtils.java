...
import com.example.rungame10.biyue.Application.BiYueApplication;
import com.example.rungame10.biyue.R;

public class UIUtils {

    public static Context getContext() {
        return BiYueApplication.getApplication();
    }

    public static Thread getMainThread() {
        return BiYueApplication.getMainThread();
    }

    public static long getMainThreadId() {
        return BiYueApplication.getMainThreadId();
    }
    ...
    public static Handler getHandler() {
        return BiYueApplication.getMainThreadHandler();
    }
